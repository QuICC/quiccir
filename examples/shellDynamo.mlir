...
func.func private @bwdScalar(%S: !complex) -> !real {
    ...
    %S1 = quiccir.cl.prj %S : !complex -> !complex attributes{kind = "P"}
...
func.func private @bwdGradScalar(%S: !complex) -> (!real, !real, !real) {
    // grad R
    %SdR1 = quiccir.cl.prj %S : !complex -> !complex attributes{kind = "D1"}
    ...
    // grad Theta
    %SdTh1 = quiccir.cl.prj %S : !complex -> !complex attributes{kind = "DivR1_Zero"}
    ...
    // grad Phi
    %SdPh1 = quiccir.cl.prj %S : !complex -> !complex attributes{kind = "DivR1_Zero"}
...
func.func private @bwdVector(%Tor: !complex, %Pol: !complex) -> (!real, !real, !real) {
    // R
    %PolR1 = quiccir.cl.prj %Pol : !complex -> !complex attributes{kind = "DivR1_Zero"}
    ...
    // Theta
    %TorTh1 = quiccir.cl.prj %Tor : !complex -> !complex attributes{kind = "P"}
    ...
    //
    %PolTh1 = quiccir.cl.prj %Pol : !complex -> !complex attributes{kind = "DivR1D1R1_Zero"}
    ...
    // Phi
    %TorPh1 = quiccir.cl.prj %Tor : !complex -> !complex attributes{kind = "P"}
    ...
    //
    %PolPh1 = quiccir.cl.prj %Pol : !complex -> !complex attributes{kind = "DivR1D1R1_Zero"}
...
func.func private @bwdCurl(%Tor: !complex, %Pol: !complex) -> (!real, !real, !real) {
    // R
    %TorR1 = quiccir.cl.prj %Tor : !complex -> !complex attributes{kind = "DivR1_Zero"}
    ...
    // Theta
    %TorTh1 = quiccir.cl.prj %Tor : !complex -> !complex attributes{kind = "DivR1D1R1_Zero"}
    %TorTh1T = quiccir.transpose %TorTh1 permutation = [1, 2, 0] : !complex -> !complex
    %TorTh2 = quiccir.al.prj %TorTh1T : !complex -> !complex attributes{kind = "D1"}
    %TorTh2T = quiccir.transpose %TorTh2 permutation = [1, 2, 0] : !complex -> !complex
    %TorTh3 = quiccir.fr.prj %TorTh2T : !complex -> !real attributes{kind = "P"}
    //
    %PolTh1 = quiccir.cl.prj %Pol : !complex -> !complex attributes{kind = "SphLapl"}
    %PolTh1T = quiccir.transpose %PolTh1 permutation = [1, 2, 0] : !complex -> !complex
    ...
    // Phi
    %TorPh1 = quiccir.cl.prj %Tor : !complex -> !complex attributes{kind = "DivR1D1R1_Zero"}
    %TorPh1T = quiccir.transpose %TorPh1 permutation = [1, 2, 0] : !complex -> !complex
    %TorPh2 = quiccir.al.prj %TorPh1T : !complex -> !complex attributes{kind = "DivS1Dp"}
    %TorPh2T = quiccir.transpose %TorPh2 permutation = [1, 2, 0] : !complex -> !complex
    %TorPh3 = quiccir.fr.prj %TorPh2T : !complex -> !real attributes{kind = "P"}
    //
    %PolPh1 = quiccir.cl.prj %Pol : !complex -> !complex attributes{kind = "SphLapl"}
    %PolPh1T = quiccir.transpose %PolPh1 permutation = [1, 2, 0] : !complex -> !complex
...
func.func private @fwdScalar(%S: !real) -> !complex {
    ...
    %S3 = quiccir.cl.int %S2T : !complex -> !complex attributes{kind = "I2"}
...
func.func private @fwdVel(%R: !real, %Theta: !real, %Phi: !real) -> (!complex, !complex){
    ...
    %ThetaTor3 = quiccir.cl.int %ThetaTor2T : !complex -> !complex attributes{kind = "I2_Zero"}
    //
    ...
    %PhiTor3 = quiccir.cl.int %PhiTor2T : !complex -> !complex attributes{kind = "I2_Zero"}
    //
    ...
    %RPol3 = quiccir.cl.int %RPol2T : !complex -> !complex attributes{kind = "I4DivR1_Zero"}
    //
    ...
    %ThetaPol3 = quiccir.cl.int %ThetaPol2T : !complex -> !complex attributes{kind = "I4DivR1D1R1_Zero"}
    //
    ...
    %PhiPol3 = quiccir.cl.int %PhiPol2T : !complex -> !complex attributes{kind = "I4DivR1D1R1_Zero"}
    //
...
func.func private @fwdMag(%R: !real, %Theta: !real, %Phi: !real) -> (!complex, !complex){
    ...
    %RTor3 = quiccir.cl.int %RTor2T : !complex -> !complex attributes{kind = "I2DivR1_Zero"}
    //
    %ThetaTor1 = quiccir.fr.int %Theta : !real -> !complex attributes{kind = "P"}
    %ThetaTor1T = quiccir.transpose %ThetaTor1 permutation = [2, 0, 1] : !complex -> !complex
    %ThetaTor2 = quiccir.al.int %ThetaTor1T : !complex -> !complex attributes{kind = "DivLlD1"}
    %ThetaTor2T = quiccir.transpose %ThetaTor2 permutation = [2, 0, 1] : !complex -> !complex
    %ThetaTor3 = quiccir.cl.int %ThetaTor2T : !complex -> !complex attributes{kind = "I2DivR1D1R1_Zero"}
    //
    %PhiTor1 = quiccir.fr.int %Phi : !real -> !complex attributes{kind = "P"}
    %PhiTor1T = quiccir.transpose %PhiTor1 permutation = [2, 0, 1] : !complex -> !complex
    %PhiTor2 = quiccir.al.int %PhiTor1T : !complex -> !complex attributes{kind = "DivLlDivS1Dp"}
    %PhiTor2T = quiccir.transpose %PhiTor2 permutation = [2, 0, 1] : !complex -> !complex
    %PhiTor3 = quiccir.cl.int %PhiTor2T : !complex -> !complex attributes{kind = "I2DivR1D1R1_Zero"}
    //
    ...
    %ThetaPol2T = quiccir.transpose %ThetaPol2 permutation = [2, 0, 1] : !complex -> !complex
    %ThetaPol3 = quiccir.cl.int %ThetaPol2T : !complex -> !complex attributes{kind = "I2_Zero"}
    //
    %PhiPol1 = quiccir.fr.int %Phi : !real -> !complex attributes{kind = "P"}
    %PhiPol1T = quiccir.transpose %PhiPol1 permutation = [2, 0, 1] : !complex -> !complex
    %PhiPol2 = quiccir.al.int %PhiPol1T : !complex -> !complex attributes{kind = "DivLlD1"}
    %PhiPol2T = quiccir.transpose %PhiPol2 permutation = [2, 0, 1] : !complex -> !complex
    %PhiPol3 = quiccir.cl.int %PhiPol2T : !complex -> !complex attributes{kind = "I2_Zero"}
    //
...
// ./bin/quiccir-opt ../examples/sphereDynamo.mlir --inline --quiccir-transform-contraction -cse --quiccir-view-wrapper='dim-rets=[7,3,6],[7,3,6],[7,3,6],[7,3,6],[7,3,6],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10] dim-args=[7,3,6] lay-args=DCCSC3D lay-rets=DCCSC3D' --inline --set-quiccir-dims='phys=6,10,10 mods=3,6,7' --set-quiccir-view-lay='lay-ppp2mpp=DCCSC3D,DCCSC3D lay-pmp2mmp=DCCSC3D,S1CLCSC3D lay-pmm2mmm=DCCSC3D,DCCSC3D' --canonicalize --quiccir-set-implptr --convert-quiccir-to-call --quiccir-view-deallocation --convert-quiccir-to-llvm --lower-quiccir-alloc --canonicalize --finalize-quiccir-view --convert-func-to-llvm --canonicalize --cse

// or

// ./bin/quiccir-opt ../examples/sphereDynamo.mlir --inline --quiccir-transform-contraction --cse --quiccir-view-wrapper='dim-rets=[[7,3,6],[7,3,6],[7,3,6],[7,3,6],[7,3,6],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10] dim-args=[7,3,6] lay-args=DCCSC3D_t lay-rets=DCCSC3D_t' --inline --set-quiccir-dims='phys=6,10,10 mods=3,6,7' --set-quiccir-view-lay='lay-ppp2mpp=DCCSC3D_t,DCCSC3D_t lay-pmp2mmp=DCCSC3D_t,S1CLCSC3D_t lay-pmm2mmm=DCCSC3D_t,DCCSC3D_t' --canonicalize --quiccir-set-implptr --quiccirToQuICC
