...
// ./bin/quiccir-opt ../examples/sphereDynamo.mlir --inline --quiccir-transform-contraction --quiccir-view-wrapper='dim-rets=[7,3,6],[7,3,6],[7,3,6],[7,3,6],[7,3,6],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10] dim-args=[7,3,6] lay-args=DCCSC3D lay-rets=DCCSC3D' --inline --set-quiccir-dims='phys=6,10,10 mods=3,6,7' --set-quiccir-view-lay='lay-ppp2mpp=DCCSC3D,DCCSC3D lay-pmp2mmp=DCCSC3D,S1CLCSC3D lay-pmm2mmm=DCCSC3D,DCCSC3D' --canonicalize --quiccir-set-implptr --convert-quiccir-to-call --quiccir-view-deallocation --convert-quiccir-to-llvm --lower-quiccir-alloc --canonicalize --finalize-quiccir-view --convert-func-to-llvm --canonicalize --cse

// or

// ./bin/quiccir-opt ../examples/sphereDynamo.mlir --inline --quiccir-transform-contraction --quiccir-view-wrapper='dim-rets=[[7,3,6],[7,3,6],[7,3,6],[7,3,6],[7,3,6],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10],[6,10,10] dim-args=[7,3,6] lay-args=DCCSC3D_t lay-rets=DCCSC3D_t' --inline --set-quiccir-dims='phys=6,10,10 mods=3,6,7' --set-quiccir-view-lay='lay-ppp2mpp=DCCSC3D_t,DCCSC3D_t lay-pmp2mmp=DCCSC3D_t,S1CLCSC3D_t lay-pmm2mmm=DCCSC3D_t,DCCSC3D_t' --canonicalize --quiccir-set-implptr --quiccirToQuICC
