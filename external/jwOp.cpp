...
view3_t &JWOp::getOp() { return _opData; }
...
/// @param uval
/// @param umod
extern "C" void _ciface_quiccir_jw_prj_layoutUval_layoutUmod(void *obj,
                                                             view3_t *pUval,
                                                             view3_t *pUmod) {
...
/// @param umod
/// @param uval
extern "C" void _ciface_quiccir_jw_int_layoutUmod_layoutUval(void *obj,
                                                             view3_t *pUmod,
                                                             view3_t *pUval) {
  auto cl = reinterpret_cast<JWOp *>(obj);
...
/// @param umod
extern "C" void
_ciface_quiccir_alloc_jw_prj_layoutUval_layoutUmod(view3_t *pNewBuffer,
                                                   view3_t *pProdBuffer) {
  /// proto is dense
  ...
  pNewBuffer->data = reinterpret_cast<double *>(
      ::operator new(sizeByte, static_cast<std::align_val_t>(sizeof(double))));
};
...
extern "C" void _ciface_quiccir_dealloc_layoutUval(view3_t *pBuffer) {
  ...
  ::operator delete(pBuffer->data, sizeByte,
                    static_cast<std::align_val_t>(sizeof(double)));
  pBuffer->dataSize = 0;
};
