...
module {
// CHECK: func.func @_view_entry(%{{.*}}: !llvm.ptr<array<90 x ptr>>, %[[RET0:.*]]: !quiccir.view<1x1x1xf64, "retLay">, %[[RET1:.*]]: !quiccir.view<1x1x1xf64, "retLay">, %[[ARG0:.*]]: !quiccir.view<2x2x2xf64, "argLay">, %[[ARG1:.*]]: !quiccir.view<2x2x2xf64, "argLay">) {
